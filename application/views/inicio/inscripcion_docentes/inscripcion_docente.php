        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-6 col-xs-12 col-sm-6 div-login">
                ...
                <div class="form-wrapper">
                    <form id="form-inscripcion-docente" class="form-inscripcion wow fadeInUp" action="<?= base_url('inscripcion_estudiante/registrar_docente') ?>" method="POST" onsubmit="return registroDocentes() ;">
