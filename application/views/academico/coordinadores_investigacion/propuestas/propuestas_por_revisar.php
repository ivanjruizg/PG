    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Propuestas presentadas por revissar</h2>
...
<fieldset>
    ...
    <div class="modal fade modal-wide2" id="modal-ver-propuesta" tabindex="-1" role="dialog"  aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="form-mostrar-propuesta" class="formulario form-horizontal"  method="POST" action="<?=base_url('coordinador/revisar_propuesta')?>">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input   readonly id="codigo" name="codigo" type="hidden"  class="form-control">


                            <label class="col-md-2 control-label" for="name">Fecha:</label>
                            <div class="col-md-3">
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-md-2 control-label" for="name">Acepetada :</label>
                            ...
                            <div class="col-md-10" style="margin-top: 10px;">
                                ...
                                Sí:
                                <input type="radio" class="flat" name="aceptada" id="genderM" value="1" checked="" required /> No:
                                <input type="radio" class="flat" name="aceptada" onclick="hora();" id="genderF" value="0" />
                        ...
                        <div class="form-group " id="obs">
                            ...
                            <label class="col-md-2 control-label" for="name">Observaciones :</label>
                        ...
                        <div class="form-group">
                            <div class="col-md-4 col-md-offset-8">
                                ...
                                <input  type="submit" class="btn btn-success pull-right" value="Revisar">
