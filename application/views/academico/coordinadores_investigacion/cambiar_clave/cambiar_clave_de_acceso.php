            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form id="cambiar-clave" class="form-horizontal form-label-left" method="post" action="<?=base_url('cordinador/cambiar_clave_de_acceso')?>" onsubmit="return cambiarClave();">
